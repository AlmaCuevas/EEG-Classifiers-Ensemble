    ...
    for N_S in N_Subj_arr:
        ...
        for N_B in N_block_arr:
            ...
            for n_trial in range(Trials):
                ...
                mean_Trial_Energy_7, std_trial_energy_7 = Calculate_power_windowed(
                    Channel_filter, FC, window_len, window_step, t_min, t_max
                )

                # Get trial
                Channel_filter = EMG_data_EXG8[n_trial, 0, :]
                # Calculate power for channel EXG8
                mean_Trial_Energy_8, std_trial_energy_8 = Calculate_power_windowed(
                    Channel_filter, FC, window_len, window_step, t_min, t_max
                )
