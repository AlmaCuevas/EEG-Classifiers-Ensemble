...
import numpy as np
import torch
from ccspnet import (CCSP, EEG_dataset, EEG_dataset_online, MVLoss, evaluate,
                     manual_seed, predict_answer, train)
...
def ccspnet_train(
    data, labels, dataset_info, true_label=1
):  # true_label=1, so 1 wil be 1 and everyone else 0
    """#Run Network
...
if __name__ == "__main__":
    ...
    data, labels = load_data_labels_based_on_dataset(
