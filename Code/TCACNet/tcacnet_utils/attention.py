...
def extract_features(inputs, model_local, batch_size, k_indexes, feature_w, n_slices, channels, device):

    k_src_idxs = []
    k_slices = []
    for i in range(n_slices):
        src_idxs, slices, left_coord = extract_one_feature(inputs, k_indexes[:, i], feature_w, batch_size, channels, device)
...
def inference(inputs, wpser, model_global, model_local, model_top, n_slices, channels, device, only_global_model, is_training):
    ...
    local_features, local_indexes = extract_features(inputs, model_local, batch_size, top_k_indices, feature_w, n_slices, channels, device)
