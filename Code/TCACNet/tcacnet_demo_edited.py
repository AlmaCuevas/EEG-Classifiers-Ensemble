...
def tcanet_net(model_global, model_local, model_top, test_loss_fn_local_top, epoch, loader, only_global_model):
    model_global.eval()
    model_local.eval()
    model_top.eval()
...
if __name__ == '__main__':
    ...
    for ep in range(n_epochs):
        ...
        valid_total_loss, valid_cross_entropy, valid_acc = tcanet_net(model_global, model_local, model_top,
                                                                test_loss_fn_local_top, ep, valid_loader,
                                                                only_global_model)
